...
public class BoostState extends ICarState{

    public BoostState(Car c) { super(c) ;}
    ...
    public void upgradeState(){
        System.out.println(car.getName() + " a déjà atteint la vitesse maximale") ;
    }
